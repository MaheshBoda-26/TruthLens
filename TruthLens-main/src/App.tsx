...
const ERROR_MESSAGES: Record<string, string> = {
  ...
  ML_BACKEND_UNAVAILABLE: "Local deepfake model is not reachable. Start the Python server on localhost:5001 and try again.",
  API_KEY_MISSING:  "API key not configured. Please add VITE_GEMINI_API_KEY to your .env file.",
  QUOTA_EXCEEDED:   "API quota exceeded. Please check your Gemini API plan and billing at ai.google.dev, or wait and try again later.",
